	...
	ext.rotateServo = function(networks, servosport, servos, degree) {
		...
		if (!hw) return;
			...
			if (networks === menus[lang]['networks'][0] ){
				...
				}else if (servo_hooker[2].name === SCBD_SERVO){
				}else if (servo_hooker[3].name === SCBD_SERVO){
				}else if (servo_hooker[4].name === SCBD_SERVO){
				}else if (servo_hooker[5].name === SCBD_SERVO){
				}else if (servo_hooker[6].name === SCBD_SERVO){
				}
