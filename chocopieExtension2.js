...
(function(ext) {
  ...
  var blocks = {
    en: [
	  ...
	  ['-'],
	  [' ', 'Stepping Motor %m.steppingMotor Direction %n Acceler %n', 'passSteppingDA', '1', '0', '0'],
	  [' ', 'Stepping Motor %m.steppingMotor Direction %n Acceler %n Angle %n', 'passSteppingDAA', '1', '0', '0', '0'],
	  [' ', 'Remote Stepping Motor %m.steppingMotor Direction %n Acceler %n', 'passRSteppingDA', '1', '0', '0'],
	  [' ', 'Remote Stepping Motor %m.steppingMotor Direction %n Acceler %n Angle %n', 'passRSteppingDAA', '1', '0', '0', '0']
    ],
    ko: [
	  ...
	  ['-'],
	  [' ', '스테핑 모터 %m.steppingMotor 방향 %n 속도 %n', 'passSteppingDA','1', '0', '0'],						//Stepping Motor definition
	  [' ', '스테핑 모터 %m.steppingMotor 방향 %n 속도 %n 각도 %n', 'passSteppingDAA','1', '0', '0', '0'],		//function_name : passSteppingDA	passSteppingDAA
	  [' ', '원격 스테핑 모터 %m.steppingMotor 방향 %n 속도 %n', 'passRSteppingDA','1', '0', '0'],				//Remote Stepping Motor definition
